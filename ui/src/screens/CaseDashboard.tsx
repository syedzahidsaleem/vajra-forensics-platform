    ...
    <div data-mode="forensic" style={{ background: 'var(--bg)', color: 'var(--text)' }} className="space-y-8">
      ...
      {activeCase ? (
        <GlassCard hover={false} className="p-5">
          ...
          <div className="flex items-center justify-between mb-2">
            ...
            {activeCase.status === 'Active' && (
              <button
                ...
                className="text-[10px] font-mono text-[var(--text)]/40 hover:text-[#EF4444]/70 transition-colors cursor-pointer"
              >
                Close Case
              </button>
            )}
          ...
          <p className="text-[10px] font-mono text-[var(--text)]/50 mb-5">
          ...
          <div className="flex items-center justify-between mb-3 pt-4 border-t border-[rgba(89,238,153,0.06)]">
            <span className="text-[10px] font-mono text-[var(--text)]/60 uppercase tracking-wider">
          ...
          {evidenceList.length > 0 ? (
            <div className="overflow-hidden rounded-lg border border-[var(--border)]/20">
              <table className="w-full text-left text-[11px] font-mono">
                <thead className="bg-[var(--surface)]/70 text-[var(--text)]/60">
                  <tr>
                ...
                <tbody className="divide-y divide-[var(--border)]/10">
                  {evidenceList.map((item) => (
                    <tr key={item.evidence_id} className="hover:bg-[var(--border)]/10 transition-colors">
                      ...
                      <td className="py-2.5 px-3 text-[var(--text)]/80 font-sans">{item.description}</td>
                      <td className="py-2.5 px-3 text-right space-x-2">
                        <button
                          onClick={() => handleOpenCustodyModal(item)}
                          className="px-2 py-1 rounded bg-[var(--surface)] text-[var(--text)]/70 hover:text-[var(--text)] text-[10px] font-mono border border-[var(--border)]/30 cursor-pointer"
                        >
                          Custody Log
                        </button>
                        <button
            ...
            <div className="py-8 text-center text-[11px] font-mono text-[var(--text)]/50">
              {loadingEvidence
      ...
      <div className="space-y-3">
        <p className="text-[10px] font-mono text-[var(--text)]/50 uppercase tracking-widest">
          ...
          {cases.map((c: CaseRecord) => {
            ...
            return (
              ...
              >
                ...
                <p className="text-[12px] font-sans text-[var(--text)]/90 mb-1 truncate">
                  {c.case_name}
                </p>
