...
| :--- | :--- | :--- | :--- | :--- | :--- |
| **Windows** | `Vajra-0.1.0-Setup.exe` | NSIS Setup | `x86_64` | Desktop UI (`vajra-tauri-app`), `WebView2Loader`, `vajra-cli`, `vajra-verify`, Signatures & ML Models | `0F79D6FE8D321735AC8D51465C78D1DD15B9EF74AAAAA0EEA53031D2D9D9BD6D` |
