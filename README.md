...
| :--- | :--- | :--- | :--- | :--- | :--- |
| **Windows** | `Vajra-0.1.0-Setup.exe` | NSIS Setup | `x86_64` | Desktop UI (`vajra-tauri-app`), `WebView2Loader`, `vajra-cli`, `vajra-verify`, Signatures & ML Models | `E670CAA3BCA26C65FE147242DC917025E4ECCC1E9CAD3EC56AEF4929EDF473AF` |
